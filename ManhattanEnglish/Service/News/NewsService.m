...
- (NSArray *)listAllNews
{
    ...
    news1.createTime = [CommonUtil dateWithString:@"2013-12-21 23:12:50" withFormatStr:yyyy_MM_dd_HH_mm_ss];
    ...
    news2.createTime = [CommonUtil dateWithString:@"2014-2-21 23:00:00" withFormatStr:yyyy_MM_dd_HH_mm_ss];
    news2.content = @"《新概念英语》2";
    
    News *news3 = [[News alloc] init];
    news3.title = @"新概念英语第三册";
    news3.createTime = [CommonUtil dateWithString:@"2014-3-6 10:00:50" withFormatStr:yyyy_MM_dd_HH_mm_ss];
